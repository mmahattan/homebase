...
export default function SpotifySection() {
  ...
  return (
    <div className="space-y-4">
      {/* Profile card */}
      <a
        href={profile?.url ?? `https://open.spotify.com/user/mats_swimz`}
        target="_blank"
      ...
      >
        ...
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-[#1DB954] ml-1 shrink-0">
