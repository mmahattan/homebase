...
export default function SpotifySection() {
  ...
  return (
    <div className="space-y-4">
      {/* Profile link */}
      <a
        href={`https://open.spotify.com/user/${USER}`}
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center gap-2.5 border border-[var(--border)] rounded px-4 py-2.5 text-sm hover:border-[var(--muted)] transition-colors"
      >
        ...
        <span className="text-[var(--muted)]">open.spotify.com/user/{USER}</span>
      </a>
